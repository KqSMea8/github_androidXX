...
public class MyMenuOptionsView extends RelativeLayout {
    ...
    public MyMenuOptionsView(Context context) {
        super(context);
        this.context = context;
    }

    public MyMenuOptionsView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(context, attrs);
    }

    public MyMenuOptionsView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.my_menu_options_view_style);
        leftTitle = typedArray.getString(R.styleable.my_menu_options_view_style_title_left);
        rightTitle = typedArray.getString(R.styleable.my_menu_options_view_style_title_right);
        mRightTitleHint = typedArray.getBoolean(R.styleable.my_menu_options_view_style_title_right_hint,false);
        leftTitleColor = typedArray.getColor(R.styleable.my_menu_options_view_style_title_left_color, Color.parseColor("#323232"));
        rightTitleColor = typedArray.getColor(R.styleable.my_menu_options_view_style_title_right_color, Color.parseColor("#999999"));
        leftImgIds = typedArray.getResourceId(R.styleable.my_menu_options_view_style_img_left_src,-1);
        rightImgIds = typedArray.getResourceId(R.styleable.my_menu_options_view_style_img_right_src,-1);

        imgLpadding = typedArray.getDimension(R.styleable.my_menu_options_view_style_imgLpadding,0);
        imgRpadding = typedArray.getDimension(R.styleable.my_menu_options_view_style_imgRpadding,0);
        imgLmargin = typedArray.getDimension(R.styleable.my_menu_options_view_style_imgLmargin,0);
        imgRmargin = typedArray.getDimension(R.styleable.my_menu_options_view_style_imgRmargin,0);

        tvLpaddingTop = typedArray.getDimension(R.styleable.my_menu_options_view_style_tvLpaddingTop,0);
        tvLpaddingBottom = typedArray.getDimension(R.styleable.my_menu_options_view_style_tvLpaddingBottom,0);



        leftTvSize = typedArray.getDimension(R.styleable.my_menu_options_view_style_leftTvSize,0);
        rightTvSize = typedArray.getDimension(R.styleable.my_menu_options_view_style_rightTvSize,0);
        typedArray.recycle();
    ...
    private void init(Context context) {
        ...
        contentView = (RelativeLayout) mMInflater.inflate(R.layout.layout_menu_options, null);
        addView(contentView);
